...
public:
    ...
    static const double RES_OF_POINT_IS_CONTAINED_IN_THIS_BUCKET ;
    static const double RES_OF_LINE_SEGMENT;
...
public:
    ...
    void destroyBucket();  //cysong : bucket�� destroy�ҽÿ�  cell ���� �ʱ�ȭ
