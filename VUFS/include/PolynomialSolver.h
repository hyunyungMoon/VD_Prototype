...
extern rg_INT poldef(dcomplex *pred,rg_INT nred,dcomplex *root,unsigned char flag);
...
unsigned char poly_check(dcomplex *pred,rg_INT *nred,rg_INT *n,dcomplex *root);
unsigned char lin_or_quad(dcomplex *pred,rg_INT nred,dcomplex *root);
...
/*
    2021.12.10. CHANYOUNG SONG.

    DO NOT USE THE FOLLOWING GLOBAL VARIABLES !!!
    THOSE MAKE PROBLEMS WHEN THEY ARE USED IN MULTI-THREADING.
    THOSE GLOBAL VARIALBS ARE CHANGED TO LOCAL VARIABLES IN MULLER.cpp
...
void initialize(dcomplex *pred,dcomplex *xb,rg_REAL *epsilon, dcomplex* x0, dcomplex* x1, dcomplex* x2, dcomplex* h1, dcomplex* h2, dcomplex* q2, rg_INT* iter);
void root_of_parabola(dcomplex* f0, dcomplex* f1, dcomplex* f2, dcomplex* q2, rg_INT* iter);
void iteration_equation(rg_REAL *h2abs, dcomplex* x2, dcomplex* h2, dcomplex* q2);
void suppress_overflow(rg_INT nred, dcomplex* x2, dcomplex* h2, dcomplex* q2);
void too_big_functionvalues(rg_REAL *f2absq, dcomplex* f2);
void convergence_check(rg_INT *overflow,rg_REAL f1absq,rg_REAL f2absq,
                       rg_REAL epsilon, dcomplex* x2, dcomplex* h2, dcomplex* q2, rg_INT* iter);
void compute_function(dcomplex *pred,rg_INT nred,rg_REAL f1absq,
                      rg_REAL *f2absq,rg_REAL epsilon, dcomplex* x2, dcomplex* f2, dcomplex* h2, dcomplex* q2, rg_INT* iter);
void check_x_value(dcomplex *xb,rg_REAL *f2absqb,rg_INT *rootd,
                   rg_REAL f1absq,rg_REAL f2absq,rg_REAL epsilon,
                   rg_INT *noise, dcomplex* x1, dcomplex* x2, dcomplex* h2, dcomplex* q2, rg_INT* iter);
void root_check(dcomplex *pred,rg_INT nred,rg_REAL f2absqb,rg_INT *seconditer,
                rg_INT *rootd,rg_INT *noise,dcomplex xb, dcomplex* x0, dcomplex* x1, dcomplex* x2, dcomplex* f0, dcomplex* f1, dcomplex* f2, rg_INT* iter);
#endif
